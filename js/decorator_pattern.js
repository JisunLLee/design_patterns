...
Sale.decorators = {};
Sale.decorators.fedex = {
    getPrice: function () {
        console.log("CALLED fedex.getPrice")
...
Sale.prototype.decorate = function (decorators) {
    const F = function () {}
    const overrides = this.constructor.decorators[decorators]
...
const Beverage = (function () {
    ...
    Beverage.prototype.setCost =function (cost) {
        this.cost = cost
    };
...
const CondimentDecorator = (function () {
    Beverage.prototype.getDescription()
})

const Espresso = (function () {
    Beverage.prototype.setDescription("에스프레소")
    Beverage.prototype.setCost(1.99)
    console.log("Espresso : ", Beverage.prototype.toString())
})

const HandDrip = (function () {
    Beverage.prototype.setDescription("핸드 드립 커피")
    Beverage.prototype.setCost(0.89)
})

const Mocha = (function (beverage) {
    const description = "모카"
    beverage.prototype.setDescription(description)
    beverage.prototype.setCost(0.20 + beverage.cost)
    return beverage.prototype.getDescription() + ", " + description
})
